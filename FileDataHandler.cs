...
public class FileDataHandler
{
    ...
    public void Delete(string profileId)
    {
        ...
        try
        {
            ...
            {
                Debug.Log("Tried to delete profile data, but data was not found at path: " + fullPath);
            }        
        }
        catch (Exception e)
        {
            Debug.Log("Failed to delete profile data for profileId: " + profileId + " at path: " + fullPath + "\n" + e);
        }
    }
}
